def descifradoCesarAlfabetoInglesMAY(cadena, n):
    ...
    while i < len(cadena):
        ...
        if (ordenClaro >= 65 and ordenClaro <= 90):
            ordenDescifrado = (((ordenClaro - 65) - int(n)) % 26) + 65

        if (ordenClaro >= 97 and ordenClaro <= 122):
            ordenDescifrado = (((ordenClaro - 97) - int(n)) % 26) + 97
...
n = input()
cifradoCESARMAY = descifradoCesarAlfabetoInglesMAY(claroCESARMAY,n)
