...
msgB.append(K1.hex())
msgB.append(K2.hex())
msgB.append(t_nb.hex())
json_B = json.dumps(msgB)

cifradoAES = funciones_aes.iniciarAES_GCM(KBT)
datos_cifrado, mac_cifrado, nonce = funciones_aes.cifrarAES_GCM(cifradoAES,json_B.encode("utf-8"))

socket_Bob.enviar(datos_cifrado)
socket_Bob.enviar(mac_cifrado)
