 ...
 *
 * demos.binPacket.AVL trees implementation
 */
...
/**
 * Search tree implemented using a balanced demos.binPacket.AVL tree. Note that keys should define an
...
public class AVL<K extends Comparable<? super K>, V> implements SearchTree<K, V> {
	...
	/**
	 * Creates an empty demos.binPacket.AVL tree.
	...
	public void delete(K key) {
		...
		// assert Tree.isAVL(root) : "demos.binPacket.AVL.delete: !isAVL";
	}
	...
	public void deleteMinim() {
		if (isEmpty())
			...
			size--;
			//assert Tree.isAVL(root) : "demos.binPacket.AVL.deleteMinim: !isAVL";
		}
	}
	...
	public void deleteMaxim() {
		if (isEmpty())
			...
			size--;
			//assert Tree.isAVL(root) : "demos.binPacket.AVL.deleteMaxim: !isAVL";
		}
	}
	...
	/** 
	 * Returns representation of demos.binPacket.AVL tree as a String.
	 */
