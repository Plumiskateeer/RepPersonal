...
// Class for representing an demos.binPacket.AVL tree of bins
public class AVL {
    static private class Node {
        Bin bin; // Bin stored in this node
        int height; // height of this node in demos.binPacket.AVL tree
        int maxRemainingCapacity; // max capacity left among all bins in tree rooted at this node
        Node left, right; // left and right children of this node in demos.binPacket.AVL tree
    ...
    private Node root; // root of demos.binPacket.AVL tree
